...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('lib/xchart/xcharts.css') }} ">
...
<body>
    ...
    <aside>
        <div id="sidebar" class="nav-collapse ">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                <p class="centered"><a href="#"><img src="{{ asset('img/logo.PNG') }}" class="img-circle"
                            width="80"></a></p>
  ...
  <script src=" {{ asset('lib/flot/jquery.flot.crosshair.js') }}"></script>
