    ...
    <div class="row mt">
        ...
        <div class="col-lg-5 col-md-5 col-sm-12">
            <div style="background:white;padding:5px;border-radius:7px;">
                ...
                <a class="btn btn-danger btn-round" style="margin-left: 150px;" href="{{ route('rapport.index')}}">Imprimer</a>
                ...
                <br>
                <a class="btn btn-danger btn-round" style="margin-left: 250px;" href="{{ route('PDF.index') }}">Facture</a>
                <h4>Panier</h4>
                        ...
                        <div class="form-goup">
                            ...
                            <div class="form-goup">
                                ...
                                <input type="number" name="nombre" id="nombre" min="0"
                                    oninput="this.value=Math.abs(this.value)" class="form-control btn-round">
                            </div>
                            <div class="form-goup">
                                <label for="prix">Montant</label>
                                <input type="number" name="montant" id="montant" min="0"
                                    oninput="this.value=Math.abs(this.value)" class="form-control btn-round">
                            </div> <br>
