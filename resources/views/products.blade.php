            ...
            <div style="background:white;z-index: 0;border-radius:7px;">
                ...
                <form method="POST" action="{{ route('products.store') }}" style="padding:5px;">
                    ...
                    <div class="form-goup">
                        ...
                        <input type="number" name="nombreP" id="nombreP" min="0" oninput="this.value=Math.abs(this.value)"
                            class="form-control btn-round">
                    </div>
                    <div class="form-goup">
                        <label for="prix">Montant</label>
                        <input type="number" name="montantP" id="montantP" min="0" oninput="this.value=Math.abs(this.value)"
                            class="form-control btn-round">
                    </div>
                    <div class="form-goup">
                ...
                <button id="button" type="button" style="margin-left: 230px;" class="btn" data-toggle="modal"
                    data-target="#myModal">
                    + Categorie
                </button>
            </div>
